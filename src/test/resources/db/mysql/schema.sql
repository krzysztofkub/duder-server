...
CREATE TABLE IF NOT EXISTS `duder`.`hobby` (
  ...
  UNIQUE INDEX `UK_kmgpilbsxayyjy1oh43i06hx8` (`name` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 11
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `duder`.`user` (
  ...
  UNIQUE INDEX `UK_t8tbwelrnviudxdaggwr1kd9b` (`login` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 14
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `duder`.`user_event` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `participant_type` VARCHAR(255) NULL DEFAULT NULL,
  `event_id` BIGINT(20) NULL DEFAULT NULL,
  `user_id` BIGINT(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `FKspe8srtv69gubpphvrnd7wekt` (`event_id` ASC),
  INDEX `FKk3smcqwou8absq8qjt3wk4vy9` (`user_id` ASC),
  CONSTRAINT `FKk3smcqwou8absq8qjt3wk4vy9`
    FOREIGN KEY (`user_id`)
    REFERENCES `duder`.`user` (`id`),
  CONSTRAINT `FKspe8srtv69gubpphvrnd7wekt`
